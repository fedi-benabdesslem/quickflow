...
// Function to show any page by name
function previewPage(pageName) {
    ...
    switch(pageName) {
        ...
        case 'email':
            ...
            break;
        default:
            console.log('Available pages: login, signup, home, meeting, email');
    }
}
// Show all pages at once for styling
function previewAll() {
...
console.log('To preview a specific page, type in console:');
console.log('  previewPage("signup")');
console.log('  previewPage("home")');
console.log('  previewPage("meeting")');
console.log('  previewPage("email")');
console.log('To see all pages at once:');
console.log('  previewAll()');
// ========== END TEMPORARY ==========