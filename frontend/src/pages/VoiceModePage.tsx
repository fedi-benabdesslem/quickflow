...
export default function VoiceModePage() {
    ...
    const [rawMarkdownMinutes, setRawMarkdownMinutes] = useState<string>('')
    ...
    const handleGenerate = useCallback(async () => {
        ...
        try {
            ...
            if (result.status === 'success' && result.content) {
                // Store raw markdown for PDF generation (preserves tables)
                setRawMarkdownMinutes(result.content)
    ...
    const handleGeneratePdf = useCallback(async () => {
        ...
        try {
            ...
            const result = await generatePdf({
                htmlContent,
                markdownContent: rawMarkdownMinutes || undefined,
